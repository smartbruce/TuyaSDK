	...
	public static void main(String[] args) throws Exception {
		...
		executorService.submit(new Runnable() {
			...
			public void run() {
				...
				try {
					sc = NatsStreaming.connect("tuya_streaming", "test12345_order_sub_" + topicSuffix, builder.build());
		...
		executorService.submit(new Runnable() {
			...
			public void run() {
				StreamingConnection sc = null;
				try {
					sc = NatsStreaming.connect("tuya_streaming", "test12345_order_pub_" + topicSuffix, builder.build());
